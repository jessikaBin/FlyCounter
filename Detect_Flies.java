...
public class Detect_Flies implements PlugInFilter {
	...
	private void findFlies(ImageProcessor ip, ImagePlus imp, double tolerance) {
		...
		// double tolerance = 18; // noise tolerance (the higher the number, the
		// less found maxima)
	...
	private void filterMaximaWithDifference(ImageProcessor ip, double tolerance) {
		...
		// } catch (IOException e ) {
		// System.out.println("Es ist folgendes Output Problem aufgetreten: " +
		// e.getMessage()
	...
	// public double getFlySizes (double x_max, double y_max, ImageProcessor ip,
	// ResultsTable rt) {
	...
	// System.out.println("Es ist folgendes Problem aufgetreten: " +
	// ex.getMessage()
	// + "\nHier ist wobei es passiert ist:\n");
	// ex.printStackTrace();
	// }
	...
	// ParticleAnalyzer pa = new ParticleAnalyzer(0, 1, rt, 0,
	...
	// splitt2 = row.split("\t");
	// }
	// double area = Double.parseDouble(splitt2[1]); // area values are in
	// second column
	// rt.reset();
	// return area;
	// }
	...
	// File file = new File("C:\\Users\\binderj\\Desktop\\" + "6577_" +
	// (int)tolerance + "_70_115" + ".txt");
